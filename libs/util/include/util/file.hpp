...
namespace Util {
     ...
     */
    FileWriteErrorCode
      file_write_lines(const std::string& path, const std::vector<std::string>& lines, bool append = false) noexcept;
     ...
     * @return \c true if the file_write operation was successful, \c false otherwise.
     */
    bool try_file_write_lines(
      const std::string& path, const std::vector<std::string>& lines, bool append = false) noexcept;
