...
namespace util::str
{
     ...
     */
    [[nodiscard]] inline std::string ljust(const std::string_view str, const std::size_t length,
     ...
     */
    [[nodiscard]] inline std::vector<std::string> split_lines(const std::string_view str,
                                                              const bool keep_ends = false) noexcept
    {
     ...
     */
    [[nodiscard]] inline std::string trim(const std::string_view str,
                                          const std::string_view chars = strpy::SPACE_CHARS) noexcept
    {
